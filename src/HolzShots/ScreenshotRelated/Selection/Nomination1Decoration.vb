...
Namespace ScreenshotRelated.Selection
    Friend Class Nomination1Decoration
        ...
        Public Overrides Sub DrawSelection(ByRef g As Graphics, ByRef selectionBorderPen As Pen)
            ...
            g.FillRectangle(QuickInfoBrush, _infoTextRectangle2)
            g.DrawString(_infoText2, QuickInfoTextFont, _infoTextBrush2, _infoTextRectangle2)
        End Sub
        ...
        Protected Overrides Sub OnUpdateCoordinates()
            ...
            _infoTextRectangle2.X = CurrentSelection.X - _infoTextRectangle2.Width
            _infoTextRectangle2.Y = CurrentSelection.Y + CInt(CurrentSelection.Height / 2) - CInt(_infoTextRectangle2.Height / 2)
