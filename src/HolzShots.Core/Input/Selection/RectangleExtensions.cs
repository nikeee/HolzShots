...
public static class RectangleExtensions
{
    ...
    public static Rectangle WorldToScreen(this Rectangle v, Rectangle virtualScreen) => v with
    {
        X = v.X - virtualScreen.X,
        Y = v.Y - virtualScreen.Y,
    };
    public static Rectangle ScreenToWorld(this Rectangle v, Rectangle virtualScreen) => v with
    {
        X = v.X + virtualScreen.X,
        Y = v.Y + virtualScreen.Y,
    };
